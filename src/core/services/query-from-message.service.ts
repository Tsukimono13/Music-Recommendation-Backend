...
- Важно: если пользователь называет страну/сцену вместе с жанром ("норвежский black metal", "финский метал", "немецкий рок") — давай один составной тег: norwegian black metal, finnish metal, german rock. Не разделяй на отдельные теги "norwegian" и "black metal": отдельный тег "norwegian" даёт в каталоге всех подряд артистов из Норвегии (поп и др.), из-за этого в ответ попадают не те артисты.
