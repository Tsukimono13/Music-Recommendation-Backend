...
- Жанры, эпохи и географию переводи на английский, lowercase. Короткие устоявшиеся формулировки: thrash metal, power metal, 80s, 90s, 2000s, classic rock, finnish metal, finnish, german metal. Страну/сцену ("финский метал", "немецкий рок") обязательно отражай тегом (finnish metal, german и т.д.).
